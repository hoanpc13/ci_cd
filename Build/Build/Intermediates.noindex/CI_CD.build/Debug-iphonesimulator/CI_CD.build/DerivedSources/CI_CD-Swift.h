...
#ifndef CI_CD_SWIFT_H
#define CI_CD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CI_CD",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5CI_CD11AppDelegate")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC5CI_CD13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC5CI_CD14ViewController")
